...
public class CarStore {
    ...
    public List<Brand> findAllBrand() {
        return this.tx(
                session -> {
                    final List result = session.createQuery("from Brand").list();
                    return result;
                }
        );
    }
    ...
    public List<Body> findAllBody() {
        return this.tx(
                session -> {
                    final List result = session.createQuery("from Body").list();
                    return result;
                }
        );
    }
    ...
    public Brand findById(int id) {
        return this.tx(
                session -> {
                    final Brand result = session.get(Brand.class, id);
                    return result;
                }
        );
    }
